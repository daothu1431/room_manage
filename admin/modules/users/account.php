        ...
        <div class="account"> 
            <div class="account-top">
                <div class="account-top__info">
                    <img src="<?php echo _WEB_HOST_ADMIN_TEMPLATE; ?>/assets/img/avatar5.png" alt="" class="account-avt">
            ...
            <div class="account-bot">
                <div class="account-bot__left"></div>
                <div class="account-bot__right">
                    ...
                    <form style="margin-top: 30px" action="" method="post">                          
                            ...
                            <button type="submit" style="background: #1bc5bd; color: #fff; border: none; font-size: 14px; padding: 8px 14px" class="btn">Cập nhật</button>
                    </form>
                </div>
            </div>
        </div>
