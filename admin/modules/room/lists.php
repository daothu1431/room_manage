...
$listAllroom = getRaw("SELECT * FROM room $filter LIMIT $offset, $perPage");
            ...
            <table class="table table-bordered mt-3">
                ...
                <tbody id="roomData">
                    ...
                    <tr>
                        ...
                        <td><?php echo $item['ngayvao'] == '0000-00-00 00:00:00' ? 'Không xác định': getDateFormat($item['ngayvao'],'d-m-Y'); ?></td> 
                        <td><?php echo $item['ngayra']  == '0000-00-00 00:00:00' ? 'Không xác định': getDateFormat($item['ngayra'],'d-m-Y'); ?></td> 
                        <td>                          
                            <?php 
